...
with open(statisticsDataFolder+ "\\Statistics_rock.csv", "r") as statisticsro:
    ...
    for row in statisticsro:
        statistics_allgenres.append(row[0:len(row)-1])
        genre.append(row[len(row)-1])
        #statistis_allgenres = preprocessing.scale(statistics_allgenres)

#print statistics_allgenres
##statistics_allgenres = numpy.array(statistics_allgenres)
statistics_allgenres = preprocessing.scale(statistics_allgenres)
#statistics_allgenres = numpy.float32(statistics_allgenres)

##for row in genre:
##    for item in statistics_allgenres:
##        item.append(row)
...
#statistics_allgenres.append(genre)

#print statistics_allgenres

#print statistics_allgenres[0]
#print statistics_allgenres[1]

#print len((statistics_allgenres[0]))
